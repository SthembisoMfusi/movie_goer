...
import { searchPersonSchema, getPersonByIdSchema,getPersonCreditsSchema } from '../schemas/person.schema.js';
...
export default async function personRoutes(fastify: FastifyInstance) {
    ...
    fastify.get('/:id', { schema: getPersonByIdSchema }, getPersonById);
     fastify.get('/:id/credits', { schema: getPersonCreditsSchema }, getPersonCredits);
}